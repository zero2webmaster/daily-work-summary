...
- Sort all active repos by commit count (most active first)
...
- Format each repo section:
  ...
  * feature/accomplishment bullet
  * bug fix/refactor bullet
  ...
  ```
- Without an AI key, use up to five unique commit-message bullets as deterministic fallback
...
- Write temporary HTML email body to `.tmp/daily-summary-YYYY-MM-DD.html`
...
- Body: HTML-formatted summary from `.tmp/daily-summary-YYYY-MM-DD.html`
