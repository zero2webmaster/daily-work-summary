...
- Fallback summary: Without AI, deterministically group commit subjects into 3-5 bullets by feature, bug fix, refactor, docs/setup, testing/reliability, and additional progress.
- Format each repo section:
  ...
  * Summary bullet 2
  ...
  ```
- One bullet per summarized theme/accomplishment
...
- The archive file is Markdown; email delivery uses the sibling `.html` render so the saved `.md` remains human-readable.
