...
- Build one global repo list (personal + org repos), sorted by commit count (most active first)
- Per repo, generate **3-5 conversational bullets** summarizing outcomes (features, refactors, bug fixes, accomplishments)
- Optional AI bullets: If any AI key is set (OPENROUTER_API_KEY, OPENAI_API_KEY, ANTHROPIC_API_KEY, GOOGLE_API_KEY), generate bullet summaries per repo. Use AI_PROVIDER variable to choose: openrouter, anthropic, gemini, openai. Auto-detects from first available key if unset.
- Fallback mode (no AI keys): deterministic bullets generated from commit messages
...
### Step 4: Save Summary Files
- Markdown archive: `summaries/YYYY-MM-DD-GitHub-Daily-Summary.md`
- HTML email body: `summaries/daily-summary-YYYY-MM-DD.html`
...
| Email Body File | `summaries/daily-summary-YYYY-MM-DD.html` | HTML (always) |
