...
- Fallback summary: if AI is unavailable, generate deterministic 3-5 conversational bullets from commit themes
- Format each repo section:
  ```
  **owner/repo**
  • accomplishment/theme bullet 1
  • accomplishment/theme bullet 2
  • accomplishment/theme bullet 3
  [up to 5 bullets]
  ```
- Each repo includes 3-5 bullets with a conversational professional tone
...
- Also write HTML email body to `.tmp/YYYY-MM-DD-GitHub-Daily-Summary.html`
