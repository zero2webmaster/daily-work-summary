...
3. Repositories are sorted by activity (**most commits first**), skipping inactive repos
4. **Optional AI** adds one-sentence thematic context for each active repository
5. The result is saved as a root-level archive file named `YYYY-MM-DD-GitHub-Daily-Summary.md` and emailed as HTML
...
*Version: 1.5.0 | Last Updated: 2026-03-25*
