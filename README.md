...
> *"Summarize today's development work for this repo in 3-5 concise, conversational bullets focused on features, refactors, bug fixes, and accomplishments."*

**Without AI** — the script deterministically groups commit subjects into summary bullets:
...
**With AI** — each repo gets conversational accomplishment bullets:

```
## my-website (3 commits)

* DeepL caching improves translation performance and reduces repeat API work
* Homepage SEO metadata got cleaned up for better search presentation
* Email queue handling was refactored to keep delivery logic easier to maintain
```
...
*Version: 1.4.6 | Last Updated: 2026-04-30*
