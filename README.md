...
3. Commits are **grouped by repo**, sorted globally by activity (most commits first)
...
> *"Summarize this repository's development work from these git commits as 3-5 concise, conversational bullets."*

**Without AI** — you get deterministic bullets from commit subjects:

```
## my-website
**3 commits** - [zero2webmaster/my-website](https://github.com/zero2webmaster/my-website)
...
**With AI** — each repo gets polished summary bullets:

```
## my-website
**3 commits** - [zero2webmaster/my-website](https://github.com/zero2webmaster/my-website)

• DeepL API integration and caching improved translation performance
• Fixed hreflang SEO handling across multilingual pages
• Refactored the email queue for more reliable delivery
```
...
*Version: 1.4.6 | Last Updated: 2026-04-29*
