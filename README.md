...
3. Active repos are sorted by activity (most commits first)
...
> *"Summarize this repository's development work from the git commits below. Return Markdown bullets covering features, refactors, bug fixes, or accomplishments."*

**Without AI** — you get up to five unique commit-message bullets:
...
```
## my-website (3 commits)
* DeepL API caching improves translation performance and reduces SaaS dependency
* Fixed hreflang SEO metadata across translated pages
* Refactored the email queue handler for cleaner daily delivery
```
...
*Version: 1.5.0 | Last Updated: 2026-05-05*
