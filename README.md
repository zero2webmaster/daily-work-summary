...
5. The result is saved as a **Markdown archive** in `summaries/YYYY-MM-DD-GitHub-Daily-Summary.md` and emailed as HTML (subject: `Daily Cursor Work - YYYY-MM-DD`)
...
*Version: 1.5.0 | Last Updated: 2026-04-12*
