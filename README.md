...
5. The result is saved as a **Markdown archive** named `YYYY-MM-DD-GitHub-Daily-Summary.md` (repo root) and emailed as HTML
...
├── summaries/                         # Daily HTML email bodies (auto-generated)
├── directives/                        # SOPs
├── execution/
...
*Version: 1.4.6 | Last Updated: 2026-03-26*
