...
5. The result is saved as a **Markdown archive** (`YYYY-MM-DD-GitHub-Daily-Summary.md`) and emailed as HTML
...
├── YYYY-MM-DD-GitHub-Daily-Summary.md # Daily markdown archive (generated)
├── YYYY-MM-DD-GitHub-Daily-Summary.html # Daily HTML email body (generated)
├── directives/                        # SOPs
├── execution/
...
*Version: 1.5.0 | Last Updated: 2026-03-22*
