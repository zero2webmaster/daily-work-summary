...
5. The result is saved as a **Markdown archive** named `YYYY-MM-DD-GitHub-Daily-Summary.md` in the repo root and emailed as HTML
...
├── YYYY-MM-DD-GitHub-Daily-Summary.md # Daily archive files (auto-generated at repo root)
├── directives/                        # SOPs
├── execution/
