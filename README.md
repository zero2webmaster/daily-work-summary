...
5. The result is saved as a **Markdown archive** at repo root as `YYYY-MM-DD-GitHub-Daily-Summary.md` and emailed as HTML
...
├── YYYY-MM-DD-GitHub-Daily-Summary.md # Daily archive files (auto-generated)
├── directives/                        # SOPs
├── execution/
...
*Version: 1.5.0 | Last Updated: 2026-03-14*
